-- Migration: 20260917070000_admin_edit_listing.sql
-- Description: Add RPC function public.admin_edit_listing to allow Admin and Super Admin accounts to directly edit a listing's content with proper staff authorization and audit logging.
