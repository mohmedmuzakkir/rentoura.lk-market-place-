  ...
  return (
    <header className="sticky top-0 z-30 bg-[#041C43] text-white px-4 py-3 shadow-md">
      <div className="max-w-xl mx-auto flex items-center justify-between">
        {/* Left Action Buttons: Back & Notifications */}
        <div className="flex items-center gap-2">
          <button
            onClick={onBack ? onBack : () => onNavigate('/')}
            className="p-2.5 rounded-full bg-white/10 hover:bg-white/20 active:scale-95 transition-all text-white cursor-pointer"
          ...
          <button
            ...
            className="relative p-2.5 rounded-full bg-white/10 hover:bg-white/20 active:scale-95 transition-all text-white cursor-pointer"
